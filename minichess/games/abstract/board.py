...
class AbstractChessBoard:
    ''' An abstract data type representing a Chess Board, agnostic of rules. '''
    def __init__(self, width, height):
        self.board_width = width
        self.board_height = height
        self.move_history = []
        self._board = self._init_board(self.board_height, self.board_width)
        self.active_color = PieceColor.WHITE
        self.LETTER_TO_COLUMN = {chr(97 + height - 1 - i): i for i in range(height)}
